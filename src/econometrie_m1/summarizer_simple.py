...
title_label = tk.Label(
    root, text="Résumé Automatique de Documents", font=("Arial", 16), bg="#f2f2f2"
)
...
open_file_button = tk.Button(
    root, text="Sélectionner un Fichier", command=open_file, bg="#4CAF50", fg="white"
)
open_file_button.pack(pady=10)

# Bouton pour résumer
summarize_button = tk.Button(
    root, text="Générer le Résumé", command=summarize_text, bg="#2196F3", fg="white"
)
