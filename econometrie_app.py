...
from fpdf.enums import Align  # Nouveau chemin dans fpdf2
import docx
...
class EconometrieAvanceeApp:
    ...
    def set_alpha_level(self):
        try:
            alpha = simpledialog.askfloat("Niveau de significativité", 
                                        "Entrez le seuil alpha (ex: 0.05 pour 5%):",
                                        parent=self.root, minvalue=0.001, maxvalue=0.5)
    ...
    def show_student_table(self):
        ...
        column_widths = {"dl": 100, "0.20": 80, "0.10": 80, "0.05": 80, 
                        "0.025": 80, "0.01": 80, "0.005": 80}
    ...
    def show_chi2_table(self):
        ...
        # Création de la table
        columns = ("v", "0.999", "0.995", "0.99", "0.975", "0.95", "0.90", "0.50", "0.10", "0.05", "0.025", "0.01", "0.005", "0.001")
    ...
    def show_fisher_table(self):
        ...
        fisher_tables = {
            1: [
                (1, 161.4, 4052.0), (2, 18.51, 98.49), (3, 10.13, 34.12),
                (4, 7.71, 21.20), (5, 6.61, 16.26), (6, 5.99, 13.74),
                (7, 5.59, 12.25), (8, 5.32, 11.26), (9, 5.12, 10.56),
                (10, 4.96, 10.04), (11, 4.84, 9.65), (12, 4.75, 9.33),
                (13, 4.67, 9.07), (14, 4.60, 8.86), (15, 4.54, 8.68),
                (16, 4.49, 8.53), (17, 4.45, 8.40), (18, 4.41, 8.28),
                (19, 4.38, 8.18), (20, 4.35, 8.10), (21, 4.32, 8.02),
                (22, 4.30, 7.94), (23, 4.28, 7.88), (24, 4.26, 7.82),
                (25, 4.24, 7.77), (26, 4.22, 7.72), (27, 4.21, 7.68),
                (28, 4.20, 7.64), (29, 4.18, 7.60), (30, 4.17, 7.56),
                (40, 4.08, 7.31), (60, 4.00, 7.08), (120, 3.92, 6.85),
                ("∞", 3.84, 6.64)
            ],
            2: [
                (1, 199.5, 4999.0), (2, 19.00, 99.00), (3, 9.55, 30.81),
                (4, 6.94, 18.00), (5, 5.79, 13.27), (6, 5.14, 10.92),
                (7, 4.74, 9.55), (8, 4.46, 8.65), (9, 4.26, 8.02),
                (10, 4.10, 7.56), (11, 3.98, 7.20), (12, 3.88, 6.93),
                (13, 3.80, 6.70), (14, 3.74, 6.51), (15, 3.68, 6.36),
                (16, 3.63, 6.23), (17, 3.59, 6.11), (18, 3.55, 6.01),
                (19, 3.52, 5.93), (20, 3.49, 5.85), (21, 3.47, 5.78),
                (22, 3.44, 5.72), (23, 3.42, 5.66), (24, 3.40, 5.61),
                (25, 3.38, 5.57), (26, 3.37, 5.53), (27, 3.35, 5.49),
                (28, 3.34, 5.45), (29, 3.33, 5.42), (30, 3.32, 5.39),
                (40, 3.23, 5.18), (60, 3.15, 4.98), (120, 3.07, 4.79),
                ("∞", 2.99, 4.61)
            ],
            3: [
                (1, 215.7, 5403.0), (2, 19.16, 99.17), (3, 9.28, 29.46),
                (4, 6.59, 16.69), (5, 5.41, 12.06), (6, 4.76, 9.78),
                (7, 4.35, 8.45), (8, 4.07, 7.59), (9, 3.86, 6.99),
                (10, 3.71, 6.55), (11, 3.59, 6.22), (12, 3.49, 5.95),
                (13, 3.41, 5.74), (14, 3.34, 5.56), (15, 3.29, 5.42),
                (16, 3.24, 5.29), (17, 3.20, 5.18), (18, 3.16, 5.09),
                (19, 3.13, 5.01), (20, 3.10, 4.94), (21, 3.07, 4.87),
                (22, 3.05, 4.82), (23, 3.03, 4.76), (24, 3.01, 4.72),
                (25, 2.99, 4.68), (26, 2.98, 4.64), (27, 2.96, 4.60),
                (28, 2.95, 4.57), (29, 2.93, 4.54), (30, 2.92, 4.51),
                (40, 2.84, 4.31), (60, 2.76, 4.13), (120, 2.68, 3.95),
                ("∞", 2.60, 3.78)
            ],
            4: [
                (1, 224.6, 5625.0), (2, 19.25, 99.25), (3, 9.12, 28.71),
                (4, 6.39, 15.98), (5, 5.19, 11.39), (6, 4.53, 9.15),
                (7, 4.12, 7.85), (8, 3.84, 7.01), (9, 3.63, 6.42),
                (10, 3.48, 5.99), (11, 3.36, 5.67), (12, 3.26, 5.41),
                (13, 3.18, 5.20), (14, 3.11, 5.03), (15, 3.06, 4.89),
                (16, 3.01, 4.77), (17, 2.96, 4.67), (18, 2.93, 4.58),
                (19, 2.90, 4.50), (20, 2.87, 4.43), (21, 2.84, 4.37),
                (22, 2.82, 4.31), (23, 2.80, 4.26), (24, 2.78, 4.22),
                (25, 2.76, 4.18), (26, 2.74, 4.14), (27, 2.73, 4.11),
                (28, 2.71, 4.07), (29, 2.70, 4.04), (30, 2.69, 4.02),
                (40, 2.61, 3.83), (60, 2.52, 3.65), (120, 2.45, 3.48),
                ("∞", 2.37, 3.32)
            ],
            5: [
                (1, 230.2, 5764.0), (2, 19.30, 99.30), (3, 9.01, 28.24),
                (4, 6.26, 15.52), (5, 5.05, 10.97), (6, 4.39, 8.75),
                (7, 3.97, 7.46), (8, 3.69, 6.63), (9, 3.48, 6.06),
                (10, 3.33, 5.64), (11, 3.20, 5.32), (12, 3.11, 5.06),
                (13, 3.02, 4.86), (14, 2.96, 4.69), (15, 2.90, 4.56),
                (16, 2.85, 4.44), (17, 2.81, 4.34), (18, 2.77, 4.25),
                (19, 2.74, 4.17), (20, 2.71, 4.10), (21, 2.68, 4.04),
                (22, 2.66, 3.99), (23, 2.64, 3.94), (24, 2.62, 3.90),
                (25, 2.60, 3.86), (26, 2.59, 3.82), (27, 2.57, 3.78),
                (28, 2.56, 3.75), (29, 2.55, 3.73), (30, 2.53, 3.70),
                (40, 2.45, 3.51), (60, 2.37, 3.34), (120, 2.29, 3.17),
                ("∞", 2.21, 3.02)
            ],
            6: [
                (1, 234.0, 5859.0), (2, 19.33, 99.33), (3, 8.94, 27.91),
                (4, 6.16, 15.21), (5, 4.95, 10.67), (6, 4.28, 8.47),
                (7, 3.87, 7.19), (8, 3.58, 6.37), (9, 3.37, 5.80),
                (10, 3.22, 5.39), (11, 3.09, 5.07), (12, 3.00, 4.82),
                (13, 2.92, 4.62), (14, 2.85, 4.46), (15, 2.79, 4.32),
                (16, 2.74, 4.20), (17, 2.70, 4.10), (18, 2.66, 4.01),
                (19, 2.63, 3.94), (20, 2.60, 3.87), (21, 2.57, 3.81),
                (22, 2.55, 3.76), (23, 2.53, 3.71), (24, 2.51, 3.67),
                (25, 2.49, 3.63), (26, 2.47, 3.59), (27, 2.46, 3.56),
                (28, 2.44, 3.53), (29, 2.43, 3.50), (30, 2.42, 3.47),
                (40, 2.34, 3.29), (60, 2.25, 3.12), (120, 2.17, 2.96),
                ("∞", 2.10, 2.80)
            ],
            8: [
                (1, 238.9, 5981.0), (2, 19.37, 99.37), (3, 8.84, 27.49),
                (4, 6.04, 14.80), (5, 4.82, 10.27), (6, 4.15, 8.10),
                (7, 3.73, 6.84), (8, 3.44, 6.03), (9, 3.23, 5.47),
                (10, 3.07, 5.06), (11, 2.95, 4.74), (12, 2.85, 4.50),
                (13, 2.77, 4.30), (14, 2.70, 4.14), (15, 2.64, 4.00),
                (16, 2.59, 3.89), (17, 2.55, 3.79), (18, 2.51, 3.71),
                (19, 2.48, 3.63), (20, 2.45, 3.56), (21, 2.42, 3.51),
                (22, 2.40, 3.45), (23, 2.38, 3.41), (24, 2.36, 3.36),
                (25, 2.34, 3.32), (26, 2.32, 3.29), (27, 2.30, 3.26),
                (28, 2.29, 3.23), (29, 2.28, 3.20), (30, 2.27, 3.17),
                (40, 2.18, 2.99), (60, 2.10, 2.82), (120, 2.01, 2.66),
                ("∞", 1.94, 2.51)
            ],
            12: [
                (1, 243.9, 6106.0), (2, 19.41, 99.42), (3, 8.74, 27.05),
                (4, 5.91, 14.37), (5, 4.68, 9.89), (6, 4.00, 7.72),
                (7, 3.57, 6.47), (8, 3.28, 5.67), (9, 3.07, 5.11),
                (10, 2.91, 4.71), (11, 2.79, 4.40), (12, 2.69, 4.16),
                (13, 2.60, 3.96), (14, 2.53, 3.80), (15, 2.48, 3.67),
                (16, 2.42, 3.55), (17, 2.38, 3.45), (18, 2.34, 3.37),
                (19, 2.31, 3.30), (20, 2.28, 3.23), (21, 2.25, 3.17),
                (22, 2.23, 3.12), (23, 2.20, 3.07), (24, 2.18, 3.03),
                (25, 2.16, 2.99), (26, 2.15, 2.96), (27, 2.13, 2.93),
                (28, 2.12, 2.90), (29, 2.10, 2.87), (30, 2.09, 2.84),
                (40, 2.00, 2.66), (60, 1.92, 2.50), (120, 1.83, 2.34),
                ("∞", 1.75, 2.18)
            ],
            24: [
                (1, 249.0, 6234.0), (2, 19.45, 99.46), (3, 8.64, 26.60),
                (4, 5.77, 13.93), (5, 4.53, 9.47), (6, 3.84, 7.31),
                (7, 3.41, 6.07), (8, 3.12, 5.28), (9, 2.90, 4.73),
                (10, 2.74, 4.33), (11, 2.61, 4.02), (12, 2.50, 3.78),
                (13, 2.42, 3.59), (14, 2.35, 3.43), (15, 2.29, 3.29),
                (16, 2.24, 3.18), (17, 2.19, 3.08), (18, 2.15, 3.00),
                (19, 2.11, 2.92), (20, 2.08, 2.86), (21, 2.05, 2.80),
                (22, 2.03, 2.75), (23, 2.01, 2.70), (24, 1.98, 2.66),
                (25, 1.96, 2.62), (26, 1.95, 2.58), (27, 1.93, 2.55),
                (28, 1.91, 2.52), (29, 1.90, 2.49), (30, 1.89, 2.47),
                (40, 1.79, 2.29), (60, 1.70, 2.12), (120, 1.61, 1.95),
                ("∞", 1.52, 1.79)
            ],
            "∞": [
                (1, 254.3, 6366.0), (2, 19.50, 99.50), (3, 8.53, 26.12),
                (4, 5.63, 13.46), (5, 4.36, 9.02), (6, 3.67, 6.88),
                (7, 3.23, 5.65), (8, 2.93, 4.86), (9, 2.71, 4.31),
                (10, 2.54, 3.91), (11, 2.40, 3.60), (12, 2.30, 3.36),
                (13, 2.21, 3.16), (14, 2.13, 3.00), (15, 2.07, 2.87),
                (16, 2.01, 2.75), (17, 1.96, 2.65), (18, 1.92, 2.57),
                (19, 1.88, 2.49), (20, 1.84, 2.42), (21, 1.81, 2.36),
                (22, 1.78, 2.31), (23, 1.76, 2.26), (24, 1.73, 2.21),
                (25, 1.71, 2.17), (26, 1.69, 2.13), (27, 1.67, 2.10),
                (28, 1.65, 2.06), (29, 1.64, 2.03), (30, 1.62, 2.01),
                (40, 1.51, 1.80), (60, 1.39, 1.60), (120, 1.25, 1.38),
                ("∞", 1.00, 1.00)
            ]
        }
    ...
    def set_decimal_places(self):
        try:
            places = simpledialog.askinteger("Décimales", "Nombre de décimales à afficher:", 
                                           parent=self.root, minvalue=0, maxvalue=10)
    ...
    def setup_data_tab(self):
        ...
        ttk.Button(frame, text="Nettoyer Données", command=self.clean_data).pack(side='left', padx=5)
        ttk.Button(frame, text="Détecter Valeurs Aberrantes", command=self.detect_outliers).pack(side='left', padx=5)
        ttk.Button(frame, text="Corriger Valeurs Aberrantes", command=self.correct_outliers).pack(side='left', padx=5)
    ...
    def setup_model_tab(self):
        ...
        ttk.Button(frame, text="Estimer le Modèle", command=self.estimate_model).grid(row=2, column=0, columnspan=2, pady=10)
        
        pred_frame = ttk.LabelFrame(self.model_tab, text="Prédiction")
        pred_frame.pack(pady=10, padx=10, fill='x')
        
        self.pred_entries = {}
        ttk.Button(pred_frame, text="Calculer Prédiction", command=self.calculate_prediction).pack(pady=5)
    ...
    def setup_diag_tab(self):
        ...
        diag_types = ['Résidus vs Ajustés', 'QQ Plot', 'Leverage', 'Histogramme Résidus', 
                     'Corrélation', 'Autocorrélation', 'Autocorrélation Partielle']
        ...
        ttk.Button(frame, text="Afficher Diagnostic", command=self.show_diagnostic).pack(side='left', padx=5)
    
    def setup_multicollinearity_tab(self):
        frame = ttk.Frame(self.multicollinearity_tab)
        frame.pack(pady=10, fill='x')
        
        ttk.Button(frame, text="Analyser Multicolinéarité", command=self.analyze_multicollinearity).pack()
        ...
        scrollbar = ttk.Scrollbar(self.multicoll_text, orient="vertical", command=self.multicoll_text.yview)
        scrollbar.pack(side='right', fill='y')
    ...
    def setup_partial_corr_tab(self):
        ...
        ttk.Button(frame, text="Calculer Corrélations Partielles", command=self.calculate_partial_correlations).pack()
        ...
        scrollbar = ttk.Scrollbar(self.partial_corr_text, orient="vertical", command=self.partial_corr_text.yview)
        scrollbar.pack(side='right', fill='y')
    ...
    def setup_stat_tests_tab(self):
        ...
        ttk.Button(frame, text="Tester Significativité Variable", command=self.test_variable_significance).pack(side='left', padx=5)
        ttk.Button(frame, text="Tester Significativité Globale", command=self.test_global_significance).pack(side='left', padx=5)
        ttk.Button(frame, text="Test de Klein", command=self.klein_test).pack(side='left', padx=5)
        ttk.Button(frame, text="Test de Farrar-Glauber", command=self.farrar_glauber_test).pack(side='left', padx=5)
        ttk.Button(frame, text="Déterminer MIX optimal", command=self.determine_optimal_mix).pack(side='left', padx=5)
        ...
        scrollbar = ttk.Scrollbar(self.stat_tests_text, orient="vertical", command=self.stat_tests_text.yview)
        scrollbar.pack(side='right', fill='y')
    ...
    def setup_export_tab(self):
        ...
        ttk.Button(frame, text="Exporter vers Excel", command=self.export_to_excel).pack(pady=5, fill='x')
        #ttk.Button(frame, text="Exporter vers Word", command=self.export_to_word).pack(pady=5, fill='x')
        ttk.Button(frame, text="Exporter vers PDF", command=self.export_to_pdf).pack(pady=5, fill='x')
        ttk.Button(frame, text="Exporter Graphiques", command=self.export_plots).pack(pady=5, fill='x')
        ...
        ttk.Checkbutton(opt_frame, text="Inclure données", variable=self.include_data).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure résumé modèle", variable=self.include_summary).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure matrices", variable=self.include_matrices).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure diagnostics", variable=self.include_diagnostics).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure graphiques", variable=self.include_plots).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure formules", variable=self.include_formulas).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure interprétations", variable=self.include_interpretations).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure corrélations partielles", variable=self.include_partial_corr).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure étapes calcul", variable=self.include_calculation_steps).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure hypothèses tests", variable=self.include_hypothesis).pack(anchor='w')
        ttk.Checkbutton(opt_frame, text="Inclure tests statistiques", variable=self.include_stat_tests).pack(anchor='w')
    ...
    def detect_outliers(self):
        ...
        try:
            ...
            for col in self.data.select_dtypes(include=[np.number]).columns:
                ...
                self.results_text.insert(tk.END, f"- Nombre de valeurs aberrantes: {len(outliers)}\n")
                
                if len(outliers) > 0:
                    self.results_text.insert(tk.END, "- Indices des valeurs aberrantes: " + 
    ...
    def correct_outliers(self):
        if len(self.outliers_indices) == 0:
            messagebox.showwarning("Avertissement", "Aucune valeur aberrante détectée ou données non chargées!")
            return
        ...
        try:
            ...
            for col in corrected_data.select_dtypes(include=[np.number]).columns:
                ...
                corrected_data.loc[(corrected_data[col] < lower_bound) | (corrected_data[col] > upper_bound), col] = median_val
    ...
    def calculate_partial_correlations(self):
        ...
        try:
            ...
            if len(x_vars) < 2:
                messagebox.showwarning("Avertissement", "Il faut au moins 2 variables pour calculer les corrélations partielles!")
                return
            ...
            for order in range(1, len(x_vars)):
                self.partial_corr_text.insert(tk.END, f"\n=== CORRÉLATIONS PARTIELLES D'ORDRE {order} ===\n")
                    ...
                    for var2 in x_vars[i+1:]:
                        ...
                        if len(all_controls) >= order:
                            ...
                            for control_vars in combinations(all_controls, order):
                                partial_corr = calculate_partial_corr(var1, var2, list(control_vars))
            ...
            for var in x_vars:
                ...
                self.partial_corr_text.insert(tk.END, 
                    f"R² partiel pour {var} (apport marginal) = {r2_partial:.4f}\n")
    ...
    def klein_test(self):
        ...
        try:
            ...
            self.stat_tests_text.insert(tk.END, "=== TEST DE KLEIN POUR LA MULTICOLINÉARITÉ ===\n\n")
            ...
            self.stat_tests_text.insert(tk.END, "Corrélations simples entre variables explicatives:\n")
            ...
            if not multicollinear_detected:
                self.stat_tests_text.insert(tk.END, "Aucun problème de multicolinéarité détecté par le test de Klein\n")
    ...
    def farrar_glauber_test(self):
        ...
        try:
            ...
            self.stat_tests_text.delete(1.0, tk.END)
            self.stat_tests_text.insert(tk.END, "=== TEST DE FARRAR ET GLAUBER POUR LA MULTICOLINÉARITÉ ===\n\n")
            ...
            self.stat_tests_text.insert(tk.END, f"Déterminant de la matrice de corrélation: {det:.4f}\n")
            ...
            if p_value < 0.05:
                self.stat_tests_text.insert(tk.END, "Conclusion: Rejet de H0 - Multicolinéarité présente\n\n")
            else:
                self.stat_tests_text.insert(tk.END, "Conclusion: Non rejet de H0 - Pas de multicolinéarité globale\n\n")
            ...
            for i, var in enumerate(x_vars):
                ...
                if f_pvalue < 0.05:
                    self.stat_tests_text.insert(tk.END, f"Conclusion: {var} est liée aux autres variables\n\n")
                else:
                    self.stat_tests_text.insert(tk.END, f"Conclusion: {var} n'est pas liée aux autres variables\n\n")
            ...
            for i in range(len(x_vars)):
                for j in range(i+1, len(x_vars)):
                    ...
                    if len(other_vars) > 0:
                        ...
                        if p_value < 0.05:
                            self.stat_tests_text.insert(tk.END, f"Conclusion: Corrélation significative entre {var1} et {var2}\n\n")
                        else:
                            self.stat_tests_text.insert(tk.END, f"Conclusion: Pas de corrélation significative entre {var1} et {var2}\n\n")
    ...
    def test_variable_significance(self):
        ...
        try:
            variable = simpledialog.askstring("Test de significativité", 
                                            "Entrez le nom de la variable à tester:",
                                            parent=self.root)
            
            if variable and variable in self.model.params.index:
                self.stat_tests_text.delete(1.0, tk.END)
                self.stat_tests_text.insert(tk.END, f"=== TEST DE SIGNIFICATIVITÉ DE {variable} ===\n\n")
                ...
                self.stat_tests_text.insert(tk.END, f"Coefficient {coef_symbol}_{variable}: {coef:.4f}\n")
                ...
                if abs(t_value) > t_critical:
                    ...
                    self.stat_tests_text.insert(tk.END, "|t observé| ≤ t critique ⇒ Non rejet de H0\n")
                ...
                if ci_low <= 0 <= ci_high:
                    self.stat_tests_text.insert(tk.END, "L'intervalle contient 0 ⇒ Non rejet de H0\n")
                else:
                    self.stat_tests_text.insert(tk.END, "L'intervalle ne contient pas 0 ⇒ Rejet de H0\n")
    ...
    def test_global_significance(self):
        ...
        try:
            ...
            self.stat_tests_text.insert(tk.END, f"Degrés de liberté: {df_model} (numérateur), {df_resid} (dénominateur)\n")
    ...
    def import_data(self):
        ...
        try:
            if file_path.endswith('.csv'):
                ...
                sheet_cb = ttk.Combobox(control_frame, textvariable=settings['sheet'], values=xls.sheet_names)
                ...
                header_spin = ttk.Spinbox(control_frame, from_=0, to=100, textvariable=settings['header_row'])
                header_spin.grid(row=1, column=1, sticky='ew', pady=2)
                
                ttk.Label(control_frame, text="Début des données:").grid(row=2, column=0, sticky='e')
                data_spin = ttk.Spinbox(control_frame, from_=0, to=100, textvariable=settings['data_start'])
                data_spin.grid(row=2, column=1, sticky='ew', pady=2)
                
                ttk.Checkbutton(control_frame, text="Noms de colonnes", variable=settings['col_names']).grid(row=3, column=0, columnspan=2, sticky='w')
                ttk.Checkbutton(control_frame, text="Index à partir colonne 1", variable=settings['index_col']).grid(row=4, column=0, columnspan=2, sticky='w')
                
                ttk.Label(control_frame, text="Valeurs manquantes:").grid(row=5, column=0, sticky='e')
                ttk.Entry(control_frame, textvariable=settings['na_values']).grid(row=5, column=1, sticky='ew', pady=2)
                ...
                def update_preview(event=None):
                    try:
                        read_params = {
                            ...
                            'na_values': settings['na_values'].get().split(",") if settings['na_values'].get() else None
                        }
                ...
                ttk.Button(btn_frame, text="Importer", command=import_dialog.destroy).pack(side='left', padx=5)
                ttk.Button(btn_frame, text="Annuler", command=import_dialog.destroy).pack(side='right', padx=5)
    ...
    def get_french_summary(self):
        ...
        summary = (
            ...
            params_table=coef_table if 'coef_table' in locals() else self.model.summary().tables[1].as_text()
        )
    ...
    def get_interpretations(self):
        ...
        if f_pval < 0.05:
            interp = (f"La F-statistique significative (p-value = {self.format_number(f_pval)}) "
                     "indique que le modèle dans son ensemble est statistiquement significatif.")
        else:
            interp = (f"La F-statistique non significative (p-value = {self.format_number(f_pval)}) "
        ...
        for i, var in enumerate(self.model.params.index):
            ...
            if pval < 0.05:
                interp = (f"La variable {var_name} est significative (p-value = {self.format_number(pval)}). "
                ...
                interp = (f"La variable {var_name} n'est pas significative (p-value = {self.format_number(pval)}), "
    ...
    def analyze_multicollinearity(self):
        if self.model is None or len(self.model.params) < 2:
            ...
            self.multicoll_text.insert(tk.END, "Pas assez de variables pour analyser la multicolinéarité")
            return
        ...
        for var, vif in vif_data:
            ...
            self.multicoll_text.insert(tk.END, 
                f"{var}: VIF = {self.format_number(vif)}{interpretation}\n")
        ...
        self.multicoll_text.insert(tk.END, f"Valeurs propres: {[self.format_number(v) for v in eigvals]}\n")
        self.multicoll_text.insert(tk.END, f"Indices de condition: {[self.format_number(ci) for ci in condition_indices]}\n")
    ...
    def update_prediction_entries(self):
        ...
        if self.model:
            ...
            # Bouton de calcul
            ttk.Button(self.pred_new_frame, text="Calculer Nouvelle Prédiction", 
                      command=self.calculate_new_prediction).grid(row=len(x_vars), column=0, columnspan=2, pady=5)
    ...
    def calculate_new_prediction(self):
        ...
        try:
            ...
            result = (f"Prédiction: y = {self.format_number(pred_mean)}\n"
    ...
    def calculate_prediction(self):
        ...
        try:
            ...
            result = (f"Prédiction pour les dernières valeurs:\n"
                ...
                with pd.ExcelWriter(file_path) as writer:
                    ...
                    if self.include_summary.get():
                        summary_df = pd.DataFrame({
                            'Statistique': ['R²', 'R² ajusté', 'F-statistique', 'Prob(F-statistique)', 
                                        'Log-vraisemblance', 'AIC', 'BIC', 'Nb. Observations', 'Seuil alpha'],
                            'Valeur': [self.model.rsquared, self.model.rsquared_adj, self.model.fvalue,
                                    self.model.f_pvalue, self.model.llf, self.model.aic, 
                                    self.model.bic, self.model.nobs, self.alpha]
                        })
                        ...
                        params_df = pd.DataFrame({
                            ...
                            'Significatif': ['Oui' if p < self.alpha else 'Non' for p in self.model.pvalues.values]
                        })
                    ...
                    if self.include_matrices.get():
                        ...
                        try:
                            xtx_inv = np.linalg.inv(xtx)
                            pd.DataFrame(xtx_inv, index=self.X.columns, columns=self.X.columns).to_excel(
                    ...
                    if self.include_diagnostics.get():
                        ...
                        tests_df = pd.DataFrame({
                            ...
                            'Statistique': [durbin_watson(self.model.resid), 
                            ...
                            'Conclusion': ['',
                                        'Hétéroscédasticité' if het_breuschpagan(self.model.resid, self.model.model.exog)[1] < self.alpha else 'OK',
                                        'Non-normalité' if normal_ad(self.model.resid)[1] < self.alpha else 'OK',
                                        'Non-normalité' if jarque_bera(self.model.resid)[1] < self.alpha else 'OK']
                        })
                    ...
                    if self.include_partial_corr.get() and self.partial_corr_results:
                        partial_corr_df = pd.DataFrame({
                            'Variables': [f"{k[0]} vs {k[1]}" for k in self.partial_corr_results.keys()],
                    ...
                    if self.include_stat_tests.get() and self.klein_test_results:
                        klein_df = pd.DataFrame({
                            'Variables': [f"{k[0]} vs {k[1]}" for k in self.klein_test_results.keys()],
                            'R²_modèle': [v[0] for v in self.klein_test_results.values()],
                            'r²_variables': [v[1] for v in self.klein_test_results.values()],
                            'Seuil alpha': [self.alpha for _ in self.klein_test_results.values()],
                            'Problème': ['Oui' if v[0] < v[1] else 'Non' for v in self.klein_test_results.values()]
                        })
                    ...
                    if self.include_stat_tests.get() and self.fg_test_results:
                        ...
                        fg_global_df = pd.DataFrame({
                            ...
                            'Conclusion': ['Multicolinéarité' if self.fg_test_results['global'][2] < self.alpha else 'Pas de multicolinéarité']
                        })
                        ...
                        fg_f_df = pd.DataFrame({
                            ...
                            'F-statistique': [v[0] for v in self.fg_test_results['f_tests'].values()],
                            'p-value': [v[1] for v in self.fg_test_results['f_tests'].values()],
                            'Seuil alpha': [self.alpha for _ in self.fg_test_results['f_tests'].values()],
                            'Conclusion': ['Liée aux autres' if v[1] < self.alpha else 'Non liée' for v in self.fg_test_results['f_tests'].values()]
                        })
                        ...
                        if 't_tests' in self.fg_test_results:
                            fg_t_df = pd.DataFrame({
                                'Variables': [f"{k[0]} vs {k[1]}" for k in self.fg_test_results['t_tests'].keys()],
                                't-statistique': [v[0] for v in self.fg_test_results['t_tests'].values()],
                                'p-value': [v[1] for v in self.fg_test_results['t_tests'].values()],
                                'Seuil alpha': [self.alpha for _ in self.fg_test_results['t_tests'].values()],
                                'Conclusion': ['Corrélation' if v[1] < self.alpha else 'Pas de corrélation' for v in self.fg_test_results['t_tests'].values()]
                            })
    ...
    def export_to_word(self):
        ...
        file_path = filedialog.asksaveasfilename(
            ...
            filetypes=[("Word", "*.docx"), ("Tous fichiers", "*.*")])
        ...
        if file_path:
            try:
                ...
                if self.include_diagnostics.get():
                    ...
                    tests = [
                        ("Durbin-Watson (autocorrélation)", f"{durbin_watson(self.model.resid):.{self.decimal_places}f}"),
                ...
                if self.include_stat_tests.get() and self.fg_test_results:
                    ...
                    row_cells[3].text = 'Multicolinéarité' if self.fg_test_results['global'][2] < 0.05 else 'Pas de multicolinéarité'
                    ...
                    if 't_tests' in self.fg_test_results:
                        ...
                        for (var1, var2), (t_val, t_pval) in self.fg_test_results['t_tests'].items():
    ...
    def export_to_pdf(self):
        ...
        try:
            ...
            pdf.cell(usable_width, 8, txt=f"Généré le {datetime.now().strftime('%d/%m/%Y à %H:%M')}", ln=1, align='C')
            pdf.ln(5)
            ...
            try:
                ...
                if self.include_summary.get() and hasattr(self.model, 'model'):
                    ...
                    stats = [
                        ...
                        ("R² ajusté", f"{getattr(self.model, 'rsquared_adj', 0):.{self.decimal_places}f}"),
                        ("F-statistique", f"{getattr(self.model, 'fvalue', 0):.{self.decimal_places}f}"),
                        ("Prob(F-statistique)", f"{getattr(self.model, 'f_pvalue', 0):.{self.decimal_places}f}"),
                        ("Log-vraisemblance", f"{getattr(self.model, 'llf', 0):.{self.decimal_places}f}"),
                ...
                if self.include_diagnostics.get() and hasattr(self.model, 'resid'):
                    ...
                    tests = [
                        ...
                        f"{dw:.{self.decimal_places}f}" if isinstance(dw, (int, float)) else str(dw)),
                        ("Breusch-Pagan (hétéroscédasticité)", 
                        f"LM={bp_test[0]:.{self.decimal_places}f}, p={bp_test[1]:.{self.decimal_places}f}" 
                        if all(isinstance(x, (int, float)) for x in bp_test) else "N/A"),
                        ("Anderson-Darling (normalité)", 
                        f"A²={ad_test[0]:.{self.decimal_places}f}, p={ad_test[1]:.{self.decimal_places}f}" 
                        if all(isinstance(x, (int, float)) for x in ad_test) else "N/A"),
                        ("Jarque-Bera (normalité)",
                        f"JB={jb_test[0]:.{self.decimal_places}f}, p={jb_test[1]:.{self.decimal_places}f}" 
                        if all(isinstance(x, (int, float)) for x in jb_test) else "N/A")
                    ]
                ...
                if hasattr(self, 'X') and hasattr(self.X, 'columns'):
                    ...
                    if vif_data:
                        vif_data.sort(key=lambda x: x[1] if isinstance(x[1], (int, float)) else 0, reverse=True)
                        ...
                        for i in range(0, len(vif_data), 2):
                            ...
                            pdf.cell(col_width * 0.4, line_height, 
                                txt=f"{vif1:.{self.decimal_places}f}" if isinstance(vif1, (int, float)) else str(vif1), 
                                border=1)
                            ...
                            if i+1 < len(vif_data):
                                ...
                                pdf.cell(col_width * 0.4, line_height, 
                                    txt=f"{vif2:.{self.decimal_places}f}" if isinstance(vif2, (int, float)) else str(vif2), 
                                    border=1)
                ...
                pdf.set_font("Arial", size=10)
                pdf.multi_cell(usable_width, 8, txt=f"Erreur lors de la génération du rapport: {str(e)}", ln=1)
            
            try:
                pdf.output(file_path)
                messagebox.showinfo("Succès", f"Rapport exporté avec succès vers:\n{file_path}")
            except Exception as e:
                messagebox.showerror("Erreur", f"Impossible d'enregistrer le fichier PDF:\n{str(e)}")
        
        except ImportError as e:
            messagebox.showerror("Erreur", f"Bibliothèque manquante: {str(e)}\nVeuillez installer les dépendances nécessaires.")
        except Exception as e:
...
if __name__ == "__main__":
    root = tk.Tk()
    app = EconometrieAvanceeApp(root)
    root.mainloop()